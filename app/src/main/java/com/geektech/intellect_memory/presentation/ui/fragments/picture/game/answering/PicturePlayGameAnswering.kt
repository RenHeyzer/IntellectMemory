package com.geektech.intellect_memory.presentation.ui.fragments.picture.game.answering
...
import com.geektech.intellect_memory.databinding.FragmentPicturePlayGameAnsweringBinding
import com.geektech.intellect_memory.domain.models.PictureQuestionModel
    ...
    override fun setupListeners() {
        ...
        binding.btnPrevious.setOnClickListener {
            if (currentImagePosition > 0) {
                listOfAnswers.remove(mSelectedOptionId)
                currentImagePosition--
                imageQuestionSetup()
            }
        }
